...
public class TexturedQuadVertices<T>: ArrayLiteralConvertible {
    ...
    public func generateVerticesWithSize(size:NSSize, handler:(index:Int, position:(GLfloat, GLfloat), texture:(GLfloat, GLfloat)) -> T) {
        
        //Size as a NSPoint
        let sap = size.getNSPoint()
        for iii in 0..<TexturedQuad.verticesPerQuad {
    ...
    */
    public func alterWithFrame(frame:NSRect, handler:(NSPoint, inout T) -> Void) {
...
public class TexturedQuad {
    ...
    public class func setPosition(position:NSRect, inout ofVertices vertices: [UVertex]) {
    ...
    public class func setTexture(texture:NSRect, inout ofVertices vertices: [UVertex]) {
    ...
    public class func pointForIndex(index:Int) -> NSPoint {
