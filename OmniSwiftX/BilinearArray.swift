...
public class BilinearArray<T: Interpolatable>: CustomStringConvertible {
    ...
    public init(populate:(Int, NSPoint) -> T) {
    ...
    */
    public func interpolateX(x:CGFloat, y:CGFloat) -> T {
        return self.interpolate(NSPoint(x: x, y: y))
    }
