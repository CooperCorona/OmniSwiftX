...
public class MultiTexturedQuad<T>: ArrayLiteralConvertible {
    ...
    */
    public func iterateQuad(quad:Int, forRect rect:NSRect, withHandler handler:(NSPoint, inout T) -> Void) {
    ...
    */
    public func iterateForRect(rect:NSRect, withHandler handler:(NSPoint, inout T) -> Void) {
