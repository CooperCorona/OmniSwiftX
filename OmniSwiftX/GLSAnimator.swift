...
public class GLSPointAnimator: GLSAnimator {
    ...
    private let handler:(NSPoint) -> ()
    private let delta:AnimationDelta<NSPoint>
    
    public init(mode:AnimationModes, duration:CGFloat?, start:NSPoint, end:NSPoint, handler:(NSPoint) -> ()) {
