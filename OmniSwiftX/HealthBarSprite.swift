...
public class HealthBarSprite: NSObject {
    ...
    public let barSize:NSSize
    public let backSize:NSSize
    ...
    public init(size:NSSize, buffer:CGFloat) {
        ...
        self.foregroundSprite.anchor = NSPoint(x: 0.0, y: 0.5)
        self.foregroundSprite.position = NSPoint(x: -self.barSize.width / 2.0, y: 0.0)
